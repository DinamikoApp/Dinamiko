...
//     if (inflationTarget <= inflationWei && transactionType == 1 && status == true) {
...
//     }
//     else if (inflationTarget <= inflationWei && transactionType == 2 && status == true) {
//         address owner_ = subscriptions[i].owner;
...
//     else if (inflationTarget <= inflationWei && transactionType == 3 && status == true) {
//         address owner_ = subscriptions[i].owner;
