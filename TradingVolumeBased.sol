...
//         string memory pathSpec = string.concat("RAW,", symbol, ",USD,VOLUME24HOURTO");
...
//     Subscription memory newSub = Subscription(msg.sender, 1, usdtAddress, tokenOut, amount, 0, volumeTarget, symbol, true);
...
//     require(subCounter < 3);
//     Subscription memory newSub = Subscription(msg.sender, 2, tokenIn, usdtAddress, amount, 0, volumeTarget, symbol, true);
//     subscriptions[subCounter] = newSub;
//     userSubscriptions[msg.sender].push(newSub);
//     subCounter = subCounter + 1;
//     // approve the contract to spend the given amount of tokens specified on the frontend
...
//     require(subCounter < 3);
//     Subscription memory newSub = Subscription(msg.sender, 3, token0, token1, amount0, amount1, volumeTarget, symbol, true);
//     subscriptions[subCounter] = newSub;
//     userSubscriptions[msg.sender].push(newSub);
//     subCounter = subCounter + 1;
//     // approve the contract to spend the given amount of tokens specified on the frontend
...
//     if (volumeTarget1 <= volume1 && transactionType1 == 2 && status1 == true) {
//         address owner_ = subscriptions[1].owner;
...
//     if (volumeTarget1 <= volume1 && transactionType1 == 3 && status1 == true) {
//         address owner_ = subscriptions[1].owner;
...
//     if (volumeTarget2 <= volume2 && transactionType2 == 1 && status2 == true) {
...
//     if (volumeTarget2 <= volume2 && transactionType2 == 2 && status2 == true) {
//         address owner_ = subscriptions[2].owner;
...
//     else if (volumeTarget2 <= volume2 && transactionType2 == 3 && status2 == true) {
//         address owner_ = subscriptions[2].owner;
...
//     if (volumeTarget3 <= volume3 && transactionType3 == 1 && status3 == true) {
...
//         transactions.buyToken(token, amount, owner_);
//     }
//     if (volumeTarget3 <= volume3 && transactionType3 == 2 && status3 == true) {
//         address owner_ = subscriptions[3].owner;
...
//     if (volumeTarget3 <= volume3 && transactionType3 == 3 && status3 == true) {
//         address owner_ = subscriptions[3].owner;
