...
//     Chainlink.Request memory req = buildChainlinkRequest(jobId, address(this), this.fulfill3.selector);
...
//    * Receive the response in the form of uint256
//    */
//   function fulfill3(bytes32 _requestId, uint256 _volume) public recordChainlinkFulfillment(_requestId) {
//     emit RequestVolume(_requestId, _volume);
//     volume3 = _volume;
//   }
